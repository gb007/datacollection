 ...
 * 表单输入框控件
 */
public class RecyclerPassordHolder extends FormItemHolder {
    ...
    public RecyclerPassordHolder(Context context, @NonNull View itemView) {
        super(itemView);
        ...
        iv_show_pass = itemView.findViewById(R.id.iv_pass_show);
    ...
    public void setData(FormFiledBean formFiledBean, Map<String, List<DictionaryBean>> dicMap, JsonObject jsonObject, boolean isCheck, RecyclerView.Adapter adapter) {
        ...
        et_value.setTypeface(Typeface.DEFAULT);
        et_value.setTransformationMethod(new PasswordTransformationMethod());
        et_value.setTransformationMethod(PasswordTransformationMethod.getInstance());//隐藏密码
...
//        setSelection(et_value);//设置光标在尾部
        ...
        iv_show_pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(et_value.getTransformationMethod() instanceof PasswordTransformationMethod){
                   iv_show_pass.setImageResource(R.drawable.form_module_icon_pass_show);
                   et_value.setTransformationMethod(HideReturnsTransformationMethod.getInstance());//明文显示
               }else{
                   iv_show_pass.setImageResource(R.drawable.form_module_icon_pass_hind);
                   et_value.setTransformationMethod(PasswordTransformationMethod.getInstance());//隐藏密码
               }
                setSelection(et_value);
            }
        });
