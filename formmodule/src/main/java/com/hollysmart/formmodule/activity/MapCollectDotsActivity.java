...
public class MapCollectDotsActivity extends CaiBaseActivity {
    ...
    public void findView() {
        ...
        findViewById(R.id.btn_remove_dot).setOnClickListener(this);
        findViewById(R.id.btn_add_dot).setOnClickListener(this);
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.iv_back) {
            finish();
        } else if (v.getId() == R.id.btn_add_dot) {
            addDot();
        } else if (v.getId() == R.id.btn_remove_dot) {
            removeDot();
