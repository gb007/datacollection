package com.hollysmart.testcollectionmodule.statusbar;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.FormModuleStatusBarHeightView);
            type = typedArray.getInt(R.styleable.FormModuleStatusBarHeightView_form_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
