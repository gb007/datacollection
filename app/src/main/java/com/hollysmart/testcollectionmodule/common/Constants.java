package com.hollysmart.testcollectionmodule.common;
...
public class Constants {
    ...
    public static final String API_SERVER_URL = "http://10.2.9.150:8885";
    /// 场馆表单id
...
//    eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2Mzc4MTk0NjEsInVzZXJuYW1lIjoiamVlY2cifQ.0hXrQYMuIQQHlpFwTqIuyrQyMj3TxSiUcoFRTxj3fQI
    ...
    public static final String PROJECT_NAME = "changyuansports";
    ...
    //七牛文件上传AK
    public static final String QINIU_ACCESSKEY = "28fPX_YqJodo-uikTzYZWDv0koVKcqvx1erzEHks";
    //七牛文件上传SK
    public static final String QINIU_SECRETKEY = "iZZJ7B1WFJ-Ulsry6xASIX6nL2itJAC7CkWQd-Mj";
    //七牛文件上传scope
    public static final String QINIU_SCOPENAME = "atspace";


    public  static final int venueTrasitionCode = 998;

    public  static final int equipTrasitionCode = 999;

    public  static final int freshFormData = 9999;
