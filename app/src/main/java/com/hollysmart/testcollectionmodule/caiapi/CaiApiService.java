...
import com.hollysmart.testcollectionmodule.bean.FormDictionaryBean;
import com.hollysmart.testcollectionmodule.bean.FormFiledBean;
import com.hollysmart.testcollectionmodule.bean.LinkDownDictBean;
...
public interface CaiApiService {
     ...
     */
    @GET("/online/cgform/api/getData/{formId}")
    Observable<BasicResponse<EquipmentFormData>> getEquipmentFormData(@Path("formId") String formId, @QueryMap Map<String, String> options);
