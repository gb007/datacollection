package com.hollysmart.testcollectionmodule.view;
...
public class ClearEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        int clearButton = typedArray.getResourceId(R.styleable.EditTextField_clearButtonDrawable,  R.drawable.form_module_icon_del);
        typedArray.recycle();
